...
class Palette {
  Color get darkButton => const Color(0xFF0050bc);

  Color get pen => const Color(0xff1d75fb);
  Color get redPen => const Color(0xFFd10841);
  Color get greenPen => const Color.fromARGB(255, 8, 209, 98);
  ...
  Color get fontFullOpacity => const Color(0xff352b42);
  Color get font => const Color(0xee352b42);
